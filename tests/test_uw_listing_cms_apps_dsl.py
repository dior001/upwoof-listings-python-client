...
class TestUwListingCmsAppsDSL:
    ...
    def test_get_uw_listing_cms_app(self, client):
        responses.add(responses.GET, 'https://pethotels.upwoof.com/api/v1/uw_listing_cms_apps/1',
    ...
    def test_update_uw_listing_cms_app(self, client):
        responses.add(responses.PUT, 'https://pethotels.upwoof.com/api/v1/uw_listing_cms_apps/1',
    ...
    def test_patch_uw_listing_cms_app(self, client):
        responses.add(responses.PATCH, 'https://pethotels.upwoof.com/api/v1/uw_listing_cms_apps/1',
    ...
    def test_delete_uw_listing_cms_app(self, client):
        responses.add(responses.DELETE, 'https://pethotels.upwoof.com/api/v1/uw_listing_cms_apps/1',
                      status=204)
